...
if("TRUE" STREQUAL "TRUE")
  set(dbscan_SOURCE_PREFIX /home/kauvoy/Race/src/lidar/dbscan)
  set(dbscan_DEVEL_PREFIX /home/kauvoy/Race/devel)
  set(dbscan_INSTALL_PREFIX "")
  set(dbscan_PREFIX ${dbscan_DEVEL_PREFIX})
else()
  set(dbscan_SOURCE_PREFIX "")
  set(dbscan_DEVEL_PREFIX "")
  set(dbscan_INSTALL_PREFIX /home/kauvoy/Race/install)
...
if(NOT "/home/kauvoy/Race/src/lidar/dbscan/include " STREQUAL " ")
  set(dbscan_INCLUDE_DIRS "")
  set(_include_dirs "/home/kauvoy/Race/src/lidar/dbscan/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dbscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kauvoy/Race/src/lidar/dbscan/${idir}'.  ${_report}")
    endif()
