...
if(NOT "/home/kauvoy/TrackRace/src/lidar/dbscan/include " STREQUAL " ")
  set(dbscan_INCLUDE_DIRS "")
  set(_include_dirs "/home/kauvoy/TrackRace/src/lidar/dbscan/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dbscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kauvoy/TrackRace/src/lidar/dbscan/${idir}'.  ${_report}")
    endif()
